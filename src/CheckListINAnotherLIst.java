...
public class CheckListINAnotherLIst {
    ...
    public static String displayText = "Order Qualifies for the following Promotions: ";
    ...
    public static void main(String [] args){
        ...
        Matcher matcher;
        //Loop Through the HashList Checking how many displayText a product Qualifies For
        ...
        if (promotionCount>0) {
            System.out.println(productIdList.toString() + " " + displayText);
